...
import telran.java52.student.dto.exception.StudentNotFoundAcception;
...
//		Student student = new Student(studentAddDto.getId(), studentAddDto.getName(), studentAddDto.getPassword());
	...
	public StudentDto findStudent(Long id) {
		...
		Student student = studentRepository.findById(id).orElseThrow(StudentNotFoundAcception::new);
